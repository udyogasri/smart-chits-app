...
import { MdDashboard, MdPeople, MdDescription, MdPayment, MdGavel, MdSettings, MdLogout } from 'react-icons/md'
...
function AdminLayout() {
  ...
  const menuItems = [
    ...
    { name: 'Members', href: '/admin/members', icon: MdPeople },
    { name: 'Chit Groups', href: '/admin/chit-groups', icon: MdDescription },
    { name: 'Payments', href: '/admin/payments', icon: MdPayment },
    { name: 'Auctions', href: '/admin/auctions', icon: MdGavel },
